$(function() {
    ...
    $('#collectionTable').DataTable({
        "ajax": {
            "url": "/collections-data/client_approve_switch_requests", // Replace with your API endpoint
...
async function approveRequests() {
    ...
    try {
        const response = await fetch('/client/approve_switch_rquest', {
            method: 'POST',
            headers: {
...
async function rejectRequests() {
    ...
    try {
        const response = await fetch('/client/reject_switch_rquest', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
