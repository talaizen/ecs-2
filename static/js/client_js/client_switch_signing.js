$(function() {
    $('#collectionTable').DataTable({
        "ajax": {
            "url": "/collections-data/client_switch_signing", // API endpoint in your FastAPI app that returns collection data
...
$('#itemsForm').on('submit', async function(e) {
    ...
    try {
        const response = await fetch('/client/switch_signing', {
            method: 'POST',
            headers: {
