...
function prepareRequestData() {
    const personalID = document.getElementById('signer-personal-id').value;
    const password = document.getElementById('pwd').value;

    return {
        signer_personal_id: personalID,
...
async function verifyAccess() {
    ...
    try {
        const response = await fetch('/master/verify-new-signing-access', {
            method: 'POST',
            headers: {
